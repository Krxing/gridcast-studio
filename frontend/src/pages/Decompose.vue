...
const fields = [{ key: 'load', label: '原始负荷', color: '#527780' }, { key: 'trend', label: '长期趋势', color: '#21876b' }, { key: 'seasonal', label: '周期成分', color: '#bc9a48' }, { key: 'residual', label: '剩余波动', color: '#9b91b5' }]
